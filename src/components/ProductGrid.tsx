...
// Produtos de fallback para quando o backend não estiver disponível
const fallbackProducts: Product[] = [
  { id: 1, nome: "Banana Prata (kg)", preco: 5.99, estoque: 50, categoriaId: 1 },
  { id: 2, nome: "Tomate Italiano (kg)", preco: 8.49, estoque: 30, categoriaId: 1 },
  { id: 3, nome: "Peito de Frango (kg)", preco: 16.90, estoque: 20, categoriaId: 2 },
  { id: 4, nome: "Leite Integral 1L", preco: 4.79, estoque: 100, categoriaId: 3 },
  { id: 5, nome: "Pão Francês (kg)", preco: 12.90, estoque: 40, categoriaId: 4 },
  { id: 6, nome: "Suco de Laranja 1L", preco: 7.49, estoque: 35, categoriaId: 5 },
  { id: 7, nome: "Pizza Congelada", preco: 14.99, estoque: 15, categoriaId: 6 },
  { id: 8, nome: "Maçã Fuji (kg)", preco: 9.99, estoque: 45, categoriaId: 7 },
];
